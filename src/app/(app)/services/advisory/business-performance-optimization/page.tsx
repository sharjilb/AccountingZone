    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 max-w-7xl">
        ...
        <section className="py-12">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600">
              We offer a complete range of performance optimization services tailored to your business needs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Performance Diagnostic Assessment</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Comprehensive evaluation of operational and financial metrics against industry benchmarks and
                  potential.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Profitability Driver Analysis</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Detailed examination of revenue streams, contribution margins, and cost structures to identify
            ...
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                <Gauge className="h-8 w-8 text-[#FFB800] mb-2" />
                <CardTitle className="text-gray-900">Operational Efficiency Evaluation</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Assessment of business processes to identify bottlenecks, redundancies, and improvement opportunities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Resource Allocation Optimization</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Analysis of human, financial, and physical resource deployment to maximize productive output.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Performance Metrics Development</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Creation of balanced scorecards and KPI frameworks tailored to your specific business objectives.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-all border-[#FFB800]/20">
              <CardHeader>
                ...
                <CardTitle className="text-gray-900">Incentive Structure Alignment</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  Design of compensation and reward systems that drive desired performance outcomes.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="py-12 bg-muted/30 rounded-lg p-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Benefits of Our Performance Optimization</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Significant enhancement of overall business profitability and return on investment.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="font-medium text-lg mb-1">Identified Opportunities</h3>
                <p className="text-muted-foreground">
                  Clear identification of highest-impact performance improvement opportunities.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Elimination of operational inefficiencies that erode financial results.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="font-medium text-lg mb-1">Enhanced Focus</h3>
                <p className="text-muted-foreground">Enhanced organizational focus on value-driving activities.</p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="font-medium text-lg mb-1">Data-Driven Decisions</h3>
                <p className="text-muted-foreground">Data-driven decision-making throughout the organization.</p>
              </div>
            </div>
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="font-medium text-lg mb-1">Sustainable Improvement</h3>
                <p className="text-muted-foreground">Sustainable performance improvement through systemic changes.</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center group">
                <div className="lg:text-right mb-8 lg:mb-0 relative">
                  <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-[#FFB800] transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-900">Comprehensive Assessment</h3>
                    <p className="text-gray-600 text-lg">
                      Thorough evaluation of current performance metrics, processes, and capabilities to identify
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center group">
                ...
                <div className="lg:text-left mb-8 lg:mb-0 relative">
                  <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-[#FFB800] transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-gray-900">Strategic Analysis</h3>
                    <p className="text-gray-600 text-lg">
                      Data-driven analysis of performance gaps and opportunities with prioritization based on impact
                      potential.
                    </p>
                  </div>
                </div>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center group">
                <div className="lg:text-right mb-8 lg:mb-0 relative">
                  <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-[#FFB800] transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-600 text-lg">
                      Development of tailored performance improvement strategies and implementation roadmaps.
                    </p>
                  </div>
                </div>
                <div className="hidden lg:block"></div>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center group">
                ...
                <div className="lg:text-left mb-8 lg:mb-0 relative">
                  <div className="bg-white p-8 rounded-xl shadow-lg border-2 border-[#FFB800] transform transition-transform duration-300 hover:-translate-y-2">
                    ...
                    <p className="text-gray-600 text-lg">
                      Execution of performance improvement initiatives with ongoing measurement and refinement.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-16 md:py-20 bg-[#fbc710] text-black w-full">
          <div className="max-w-3xl mx-auto text-center space-y-6 px-4 md:px-6">
            ...
            <p className="text-lg text-black/90 max-w-2xl mx-auto">
              Contact Accounting Zone to discuss how our Business Performance Optimization services can identify and
              capture improvement opportunities that drive sustainable growth and profitability.
            </p>
