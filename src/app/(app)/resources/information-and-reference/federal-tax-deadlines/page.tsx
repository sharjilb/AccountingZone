            ...
            <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-8 max-w-6xl">
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  ...
                  <CardTitle>Annual Tax Filing Dates</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">Deadlines for personal and business tax returns.</p>
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  <Calculator className="h-8 w-8 mb-2 text-[#fbc710]" />
                  <CardTitle>Quarterly Estimated Tax Deadlines</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">Due dates for self-employed and businesses.</p>
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  <Clock className="h-8 w-8 mb-2 text-[#fbc710]" />
                  <CardTitle>Tax Extension Filing Process</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">How to apply for extra time.</p>
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  <AlertTriangle className="h-8 w-8 mb-2 text-[#fbc710]" />
                  <CardTitle>Penalty Avoidance Strategies</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">Tips for timely payments.</p>
                </CardContent>
              </Card>
            </div>
          </div>
