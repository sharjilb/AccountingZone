              ...
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-8 max-w-6xl">
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Step-by-Step Tax Guides</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">
                      Covering topics like deductions, credits, and compliance.
                    </p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>Tax Calculators & Tools</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Estimate tax liabilities and potential refunds.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <Briefcase className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Industry-Specific Tax Insights</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Custom resources for different businesses.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <HelpCircle className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>FAQs and Expert Articles</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Answering the most common tax-related questions.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
