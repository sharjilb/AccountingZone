            ...
            <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-8 max-w-6xl">
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  ...
                  <CardTitle>New Tax Legislation Summaries</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">Breaking down key changes in tax laws.</p>
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                  <AlertCircle className="h-8 w-8 mb-2 text-[#fbc710]" />
                  <CardTitle>IRS Policy Revisions</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-center">Updates on tax code modifications.</p>
                </CardContent>
              </Card>
              <Card className="h-full">
                <CardHeader className="flex items-center justify-center">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-center">
                    How tax changes affect different businesses and individuals.
                  </p>
                </CardContent>
              </Card>
              <Card className="h-full">
                ...
                <CardContent>
                  <p className="text-muted-foreground text-center">Ensuring businesses stay tax-compliant.</p>
                </CardContent>
              </Card>
            </div>
          </div>
