              ...
              <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 mt-8 max-w-6xl">
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    ...
                    <CardTitle>IRS Rules & Compliance Guidelines</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Understanding federal tax laws.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <AlertCircle className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Audit Risk Minimization</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">How to avoid common tax pitfalls.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <Briefcase className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>Small Business & Self-Employed FAQs</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Specific guidance for entrepreneurs.</p>
                  </CardContent>
                </Card>
                <Card className="h-full">
                  <CardHeader className="flex items-center justify-center">
                    <Map className="h-8 w-8 mb-2 text-[#fbc710]" />
                    <CardTitle>State-Specific Regulatory Questions</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-muted-foreground text-center">Covering different tax laws across states.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
